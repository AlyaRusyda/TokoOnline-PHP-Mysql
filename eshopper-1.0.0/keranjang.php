...
<body>
                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="keranjang.php" class="dropdown-item active">Shopping Cart</a>
                ...
                <div class="table-responsive mb-5">
                    <table class="table table-bordered text-center mb-0">
                        ...
                        <?php foreach (@$_SESSION['cart'] as $key_produk => $val_produk) : ?>
                            <?php $subtotal = $val_produk['harga'] * $val_produk['qty']; ?>
                            <?php $button_hapus = "<a href='hapus_cart.php?id=" . $key_produk."' class='btn btn-primary' onclick='return confirm(\"Apakah anda yakin menghapus data ini?\")'>X</a>"; ?>
                            <tbody class="align-middle">
                                <tr>
                                    <td class="align-middle"><?= ($key_produk + 1) ?></td>
                                    <td class="align-middle"><img src="img/foto_produk/<?= $val_produk['foto'] ?>" alt="" style="width: 50px;"> <?= $val_produk['nama_produk'] ?></td>
                                    <td class="align-middle"><?= $val_produk['harga'] ?></td>
                                    <td class="align-middle"><?= $val_produk['qty'] ?></td>
                    ...
                    <div class="d-flex align-items-center mb-4 mt-2 pt-2">
                        <form action="checkout.php" method="GET">
                            <a href="index_pelanggan.php" class="btn btn-primary">Add Product</a>
                            <input type="submit" value="Check Out" class="btn btn-primary px-3">
                        </form>
                    </div>
                </div>
            </div>
    ...
    <?php else : ?>
        <h3 class="text-center">Tidak ada barang di keranjang</h3>
    <?php endif ?>
    <!-- Cart End -->
