...
<head>
    <meta charset="utf-8">
    <title>EShopper - Detail Produk</title>
    ...
    ?>
        ...
        <div class="container-fluid bg-secondary mb-5">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
                <h1 class="font-weight-semi-bold text-uppercase mb-3">Products Details</h1>
                <div class="d-inline-flex">
                    <p class="m-0"><a href="">Product Details</a></p>
                    <p class="m-0 px-2">-</p>
                    <p class="m-0"><?= $dt_produk['kategori'] ?></p>
                </div>
            </div>
        </div>
        <!-- Page Header End -->
        ...
        <div class="container-fluid py-5">
            <div class="row px-xl-5">
                    ...
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner border">
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="img/foto_produk/<?= $dt_produk['foto'] ?>" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 pb-5">
                    <h3 class="font-weight-semi-bold"><?= $dt_produk['nama_produk'] ?></h3>
                    ...
                    <h3 class="font-weight-semi-bold mb-4">IDR <?= substr($dt_produk['harga'], 0, 20) ?></h3>
                    <p class="mb-4"><?= substr($dt_produk['deskripsi'], 0, 200) ?></p>
                    <form action="masukkankeranjang.php?id_produk=<?= $dt_produk['id_produk'] ?>" method="post">
                        <table class="table table-hover table-striped">
                            <thead>
                                <tr>
                                    <td>Harga</td>
                                    <td>IDR<?= $dt_produk['harga'] ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="payment" class="form-control">
                                            ...
                                            <?php
                                            include "connect.php";
                                            $qry_metode_pembayaran = mysqli_query($conn, "select * from metode_pembayaran");
                                            while ($data_metode_pembayaran = mysqli_fetch_array($qry_metode_pembayaran)) {
                                                echo '<option value="' . $data_metode_pembayaran['payment'] . '">' . $data_metode_pembayaran['payment'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </td>
                        ...
                        <div class="d-flex align-items-center mb-4 pt-2">
                            <form action="masukkankeranjang.php" method="GET">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <div class="d-inline-flex">
                            ...
                            <a class="text-dark px-2" href="https://twitter.com/alyamhrst">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a class="text-dark px-2" href="https://www.instagram.com/alyarusyda__/">
                                <i class="fab fa-instagram"></i>
                            </a>
                        </div>
                    </div>
