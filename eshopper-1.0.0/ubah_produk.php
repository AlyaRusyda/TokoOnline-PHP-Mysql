...
<body>
    ...
    <div class="row" style="margin-top:50px;">
        ...
        <div class="col-md rounded bg-light" style="box-shadow: 0px 0px 5px 1px; padding: 30px">
            <h3 align="center" class="mb-4">Edit Product</h3>
            <form action="proses_ubah_produk.php" method="post">
                ...
                <input type="submit" name="simpan" value="Ubah Produk" class="btn btn-primary mt-3">
            </form>
        </div>
        <div class="col-md"></div>
    </div>
