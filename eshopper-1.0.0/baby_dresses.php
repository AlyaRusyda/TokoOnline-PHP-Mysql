                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="detail_pelanggan.php" class="nav-item nav-link">Product Details</a>
                            <div class="nav-item dropdown">
    ...
    <section id="produk" class="col-md rounded" style="padding: 30px; margin-bottom: 5rem;">
        <div class="col-md rounded" style="padding: 30px;">
            <div class="text-center mb-4">
                <h2 class="section-title px-5"><span class="px-2">Baby's Dresses List</span></h2>
            </div>
            <div class="row">
                <?php
                include "connect.php";
                $qry_produk = mysqli_query($conn, "select * from produk where kategori = 'Baby Dresses' ");
