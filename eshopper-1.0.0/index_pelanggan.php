...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="index_pelanggan.php" class="nav-item nav-link active">Home</a>
                            <div class="nav-item dropdown">
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a href="#produk" class="btn btn-light py-2 px-3">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a href="#produk" class="btn btn-light py-2 px-3" style="scroll-behavior: smooth;">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="men_dresses.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="women_dresses.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="baby_dresses.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="accessories.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="bags.php" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <a href="shoes.php" class="cat-img position-relative overflow-hidden mb-3">
    ...
    <!-- Products Start -->
    <section id="produk" class="col-md rounded" style="padding: 30px; margin-bottom: 5rem;">
        <div class="col-md rounded" style="padding: 30px;">
            <center>
                <h2 style="margin-top: 3rem; margin-bottom: 2rem;">Product List</h2>
            </center>
            <div class="row">
                <?php
                include "connect.php";
                $qry_produk = mysqli_query($conn, "select * from produk where kategori = 'Women Dresses' ");
                while ($dt_produk = mysqli_fetch_array($qry_produk)) {
                ?>
                    <div class="col-md-3">
                        <div class="card mt-3 mb-3">
                            <center><img src="img/foto_produk/<?= $dt_produk['foto'] ?>" width="305px" height="305px" class="hoverproduk"></center>
                            <div class="card-body">
                                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                    <h6 class="text-truncate mb-3"><?= $dt_produk['nama_produk'] ?></h6>
                                    <div class="d-flex justify-content-center">
                                        <h6>IDR <?= substr($dt_produk['harga'], 0, 20) ?></h6>
                                    </div>
                                </div>
                                <div class="card-footer d-flex justify-content-between bg-light border">
                                    <a href="detail_produk.php?id_produk=<?= $dt_produk['id_produk'] ?>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
