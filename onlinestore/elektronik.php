...
<body>
    <section id="elektronik" class="col-md rounded" style="padding: 30px; margin-left: 3rem; margin-right: 3rem;"><br><br>
        <div class="col-md rounded bg-light" style="padding: 30px;">
            <center>
                <h2 style="margin-top: 0px;">Produk Elektronik</h2>
                
            </center>
            <h5>Selamat datang <?= $_SESSION['id_pelanggan'] ?> </h5>
            <div class="row">
                <?php
                include "connect.php";
                $qry_produk = mysqli_query($conn, "select * from produk where kategori = 'elektronik'");
