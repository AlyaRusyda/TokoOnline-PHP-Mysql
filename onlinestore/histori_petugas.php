                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <table class="table table-hover striped">
                                    ...
                                    <tbody>
                                        ...
                                        session_start();
                                        include 'connect.php';
                                        $qry_histori = mysqli_query($conn, "select produk.nama_produk, transaksi.tgl_transaksi, produk.harga, detail.qty, produk.foto, transaksi.id_transaksi from produk, transaksi, detail_transaksi detail where transaksi.id_produk = produk.id_produk and transaksi.id_transaksi = detail.id_transaksi");
                                        $no = 0;
