...
<body>
    ...
    <div class="col-md rounded bg-light" style="box-shadow: 4px 4px 5px -4px;padding:10px">
        ...
        <form action="proses_ubah_produk.php" method="post">
            ...
            Kategori :
            <select name="kategori" id="" class="form-control" <?= $dt_produk['kategori'] ?>>
                ...
                <option value="buku">Sepatu</option>
                <option value="buku">Otomotif</option>
            </select>
            Foto Produk :
            <input type="file" name="foto" value="<?= $dt_produk['foto'] ?>" class="form-control">
