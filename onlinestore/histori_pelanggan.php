                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <table class="table table-hover striped">
                                    ...
                                    <tbody>
                                        <?php
                                        include 'connect.php';
                                        $qry_histori = mysqli_query($conn, "select produk.nama_produk, qty, produk.harga, produk.foto, subtotal from detail_transaksi, produk, transaksi where detail_transaksi.id_produk = produk.id_produk order by id_detail_transaksi desc;");
                                        $no = 0;
