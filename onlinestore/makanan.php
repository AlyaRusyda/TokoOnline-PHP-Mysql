...
<body>
    <section id="makanan" class="col-md rounded" style="padding: 30px; margin-left: 3rem; margin-right: 3rem;"><br><br>
        <div class="col-md rounded bg-light" style="padding: 30px;">
            <center>
                <h2 style="margin-top: 0px;">Produk Makanan dan Minuman</h2>
            </center>
            <div class="row">
                <?php
                include "connect.php";
                $qry_produk = mysqli_query($conn, "select * from produk where kategori = 'makanan'");
